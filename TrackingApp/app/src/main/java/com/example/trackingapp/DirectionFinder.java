...
public class DirectionFinder {
    private static final String DIRECTION_URL_API = "https://maps.googleapis.com/maps/api/directions/json?&alternatives=true&";
    private static final String GOOGLE_API_KEY = "XXXXXXXXXXXXXXXXXX";
